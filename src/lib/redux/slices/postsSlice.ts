...
export const fetchPostById = createAsyncThunk<IPost, string>('posts/fetchPostById', async (id) => {
  const response = await axiosInstance.get(`/posts/${id}`);
  return response.data;
});

export const createNewPost = createAsyncThunk<IPost, Omit<IPost, 'id'>>('posts/createNewPost', async (newPost) => {
